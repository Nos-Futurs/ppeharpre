    ...
    <Layout>
      ...
      >
        ...
        <div class="paragraphe">
          ...
          mettre en mouvement. J'aime la marche, elle symbolise bien ce
        ...
        <div class="paragraphe">
          ...
          années, j'ai connu des transformations épanouissantes. Je me suis
          alors engagé à mon tour dans l’accompagnement en suivant la formation
          très enrichissante de cette école. La gestalt thérapie appréhende la
          personne dans sa globalité et dans son environnement sans jugement
          (lien). Elle repose sur le lien entre l’accompagné et le thérapeute et
          s’ancre dans le présent pour questionner l’ensemble du vécu.
        </div>
        <div>
          <img src={sea_rocks} style={{ width: "100%" }} />
        </div>
        <div class="paragraphe">
          Profondément respectueux des personnes, je m’attache à être à
          l’écoute, non seulement des mots mais également des images, du corps
          et des émotions avec une « très grande qualité de présence ». Mon
          ancrage rassure. Il permet à la personne accompagnée une mise en
          mouvement et un espace protégé pour contacter ses sensations et ses
          émotions. Ce temps unique pour soi offre l'opportunité d'aller
          explorer ses questionnements, ses incertitudes et d'ouvrir le champ
          des possibles. J'accompagne avec une approche non jugeante dans le
        ...
        <div class="paragraphe">
          ...
          idées fixes… tout cela est partagé par de nombreux individus et en
          même temps, ce n'est en aucun cas inéluctable. Comme cela a été le cas
