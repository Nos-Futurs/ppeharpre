  ...
  return (
    <Layout>
      ...
      >
        ...
        <div class="paragraphe">
          Conceptualisée dans les années 50 à plusieurs mains sous la houlette
          de Fritz et Laura Perls et toujours en mouvement, la gestalt est une
          des psychothérapies humanistes existentielles la plus étendue.
          <ul>
            <li>
            ...
            <li>
              adans les relations que la personne accompagnée vit à l'extérieur
              ou au sein du cabinet, des formes répétitives ou figées peuvent se
